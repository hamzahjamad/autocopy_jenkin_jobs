...
{script name} 'jenkin_username' 'jenkin_user_api_token' 'new_job_name' 'job_name_to_copy' 'jenkin_url' 'jenkin_project_token' 'bitbucket_username' 'bitbucket_repository_name' 

for example (in windows)    
sh jenkin_copy_job.sh jenkin_username jenkin_user_api_token new_job_name job_name_to_copy jenkin.test:8080 'jenkin_project_token' 'bitbucket_username' 'bitbucket_repository_name' 
